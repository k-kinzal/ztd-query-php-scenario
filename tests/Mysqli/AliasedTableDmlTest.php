...
/**
 * Table aliases in UPDATE and DELETE statements on shadow data.
 ...
 * @spec SPEC-4.3
 */
class AliasedTableDmlTest extends AbstractMysqliTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->mysqli->query("INSERT INTO atd_products (id, name, price, active, category) VALUES
    ...
    {
        $this->disableZtd();
        $result = $this->mysqli->query("SELECT COUNT(*) AS cnt FROM atd_products");
