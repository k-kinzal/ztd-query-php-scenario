 ...
 */
class CorrelatedSubqueryAfterMutationTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $raw->query('DROP TABLE IF EXISTS mi_corr_orders');
        $raw->query('DROP TABLE IF EXISTS mi_corr_customers');
        $raw->query('CREATE TABLE mi_corr_customers (id INT PRIMARY KEY, name VARCHAR(50))');
        $raw->query('CREATE TABLE mi_corr_orders (id INT PRIMARY KEY, customer_id INT, amount DECIMAL(10,2))');
        $raw->close();
    }
