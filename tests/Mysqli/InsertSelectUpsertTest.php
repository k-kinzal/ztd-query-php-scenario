 ...
 */
class InsertSelectUpsertTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $raw->query('DROP TABLE IF EXISTS mi_isu_target');
        $raw->query('DROP TABLE IF EXISTS mi_isu_source');
        $raw->query('CREATE TABLE mi_isu_source (id INT PRIMARY KEY, name VARCHAR(50), score INT)');
        $raw->query('CREATE TABLE mi_isu_target (id INT PRIMARY KEY, name VARCHAR(50), score INT)');
        $raw->close();
    }
