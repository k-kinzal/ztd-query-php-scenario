 ...
 */
class LastAffectedRowsEdgeCaseTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $raw->query('DROP TABLE IF EXISTS mi_lar_test');
        $raw->query('CREATE TABLE mi_lar_test (id INT PRIMARY KEY, name VARCHAR(50), score INT, active TINYINT DEFAULT 1)');
        $raw->close();
    }
