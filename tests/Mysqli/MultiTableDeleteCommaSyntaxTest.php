 ...
 */
class MultiTableDeleteCommaSyntaxTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $raw->query('CREATE TABLE mi_md_users (id INT PRIMARY KEY, name VARCHAR(50), status VARCHAR(20))');
        $raw->query('CREATE TABLE mi_md_orders (id INT PRIMARY KEY, user_id INT, total INT)');
        $raw->close();
    }
