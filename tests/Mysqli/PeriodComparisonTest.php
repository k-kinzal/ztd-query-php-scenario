 ...
 * @spec SPEC-3.3
 */
class PeriodComparisonTest extends AbstractMysqliTestCase
{
    protected function getTableDDL(): string|array
    {
        return [
            'CREATE TABLE mi_pc_revenue (
                id INT PRIMARY KEY,
                product VARCHAR(255),
                region VARCHAR(255),
                amount DOUBLE,
    ...
    protected function setUp(): void
    {
        ...
        // 2023 Q1 sales
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (1, 'Widget', 'North', 1000, '2023-01-15', 2023, 1)");
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (2, 'Gadget', 'South', 2000, '2023-02-10', 2023, 2)");
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (3, 'Widget', 'North', 1200, '2023-03-20', 2023, 3)");
        // 2023 Q2 sales
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (4, 'Widget', 'South', 800, '2023-04-05', 2023, 4)");
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (5, 'Gadget', 'North', 2500, '2023-05-18', 2023, 5)");
        // 2024 Q1 sales (for YoY comparison)
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (6, 'Widget', 'North', 1500, '2024-01-12', 2024, 1)");
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (7, 'Gadget', 'South', 2200, '2024-02-08', 2024, 2)");
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (8, 'Widget', 'North', 1800, '2024-03-25', 2024, 3)");
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (9, 'Gadget', 'South', 500, '2024-03-30', 2024, 3)");
        // 2024 Q2 sales
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (10, 'Widget', 'South', 1100, '2024-04-10', 2024, 4)");
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (11, 'Gadget', 'North', 3000, '2024-05-22', 2024, 5)");
    }
    ...
    public function testPreparedPeriodComparison(): void
    {
        ...
        $stmt->bind_param('iiii', $yearA, $yearB, $monthFrom, $monthTo);
        $yearA = 2023;
        $yearB = 2024;
        $monthFrom = 1;
        $monthTo = 3;
    ...
    public function testPeriodComparisonAfterInsert(): void
    {
        ...
        $this->mysqli->query("INSERT INTO mi_pc_revenue VALUES (20, 'Widget', 'North', 5000, '2024-01-28', 2024, 1)");
