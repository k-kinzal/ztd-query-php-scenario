 ...
 */
class PreparedUpdateSelfReferencingTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $raw->query('DROP TABLE IF EXISTS mi_pupd_test');
        $raw->query('CREATE TABLE mi_pupd_test (id INT PRIMARY KEY, name VARCHAR(50), counter INT, balance DECIMAL(10,2))');
        $raw->close();
    }
