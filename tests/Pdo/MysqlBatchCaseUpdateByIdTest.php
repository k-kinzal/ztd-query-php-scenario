 ...
 * @spec SPEC-4.2
 */
class MysqlBatchCaseUpdateByIdTest extends AbstractMysqlPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE mp_bcu_users (
            id INT PRIMARY KEY,
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("INSERT INTO mp_bcu_users VALUES (1, 'Alice', 'user', 10)");
        $this->pdo->exec("INSERT INTO mp_bcu_users VALUES (2, 'Bob', 'user', 20)");
        $this->pdo->exec("INSERT INTO mp_bcu_users VALUES (3, 'Carol', 'user', 30)");
        $this->pdo->exec("INSERT INTO mp_bcu_users VALUES (4, 'Dave', 'user', 40)");
    }
    ...
    public function testBatchUpdateSingleColumn(): void
    {
        try {
            ...
            $rows = $this->ztdQuery("SELECT id, name, role FROM mp_bcu_users ORDER BY id");
    ...
    public function testBatchUpdateMultipleColumns(): void
    {
        try {
            ...
            $rows = $this->ztdQuery("SELECT id, role, score FROM mp_bcu_users ORDER BY id");
            $this->assertCount(4, $rows);
    ...
    public function testBatchUpdatePreparedWithParams(): void
    {
        try {
            ...
            $rows = $this->ztdQuery("SELECT id, role FROM mp_bcu_users ORDER BY id");
    ...
    public function testBatchUpdateWithoutWhere(): void
    {
        try {
            ...
            $rows = $this->ztdQuery("SELECT id, score FROM mp_bcu_users ORDER BY id");
            $this->assertCount(4, $rows);
