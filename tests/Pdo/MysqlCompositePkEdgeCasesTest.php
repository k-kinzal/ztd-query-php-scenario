 ...
 * @spec SPEC-3.6
 */
class MysqlCompositePkEdgeCasesTest extends AbstractMysqlPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return [
            'CREATE TABLE orders (order_id INT PRIMARY KEY, customer VARCHAR(50), status VARCHAR(20))',
            'CREATE TABLE order_items (order_id INT, item_id INT, product VARCHAR(50), quantity INT, price DOUBLE, PRIMARY KEY (order_id, item_id))',
        ];
    }
