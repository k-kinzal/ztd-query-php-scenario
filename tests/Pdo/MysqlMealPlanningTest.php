 ...
 * GROUP BY with HAVING for dietary filters, and prepared statement for day lookup (MySQL PDO).
 * @spec SPEC-10.2.146
 */
class MysqlMealPlanningTest extends AbstractMysqlPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return [
            'CREATE TABLE mp_mp_meals (
                id INT AUTO_INCREMENT PRIMARY KEY,
                name VARCHAR(100),
                category VARCHAR(50),
                dietary_tag VARCHAR(50)
            )',
            'CREATE TABLE mp_mp_meal_ingredients (
                id INT AUTO_INCREMENT PRIMARY KEY,
                meal_id INT,
            ...
            'CREATE TABLE mp_mp_weekly_plan (
                id INT AUTO_INCREMENT PRIMARY KEY,
                day_of_week VARCHAR(10),
                meal_slot VARCHAR(20),
                meal_id INT
            )',
            'CREATE TABLE mp_mp_days (
                id INT AUTO_INCREMENT PRIMARY KEY,
                day_name VARCHAR(10)
            )',
        ];
    ...
    {
        return ['mp_mp_days', 'mp_mp_meal_ingredients', 'mp_mp_meals', 'mp_mp_weekly_plan'];
    }
    ...
    protected function setUp(): void
    {
        ...
        // Meals
        $this->pdo->exec("INSERT INTO mp_mp_meals VALUES (1, 'Oatmeal', 'breakfast', 'vegan')");
        $this->pdo->exec("INSERT INTO mp_mp_meals VALUES (2, 'Eggs Benedict', 'breakfast', 'none')");
        $this->pdo->exec("INSERT INTO mp_mp_meals VALUES (3, 'Caesar Salad', 'lunch', 'none')");
        $this->pdo->exec("INSERT INTO mp_mp_meals VALUES (4, 'Veggie Wrap', 'lunch', 'vegetarian')");
        $this->pdo->exec("INSERT INTO mp_mp_meals VALUES (5, 'Grilled Salmon', 'dinner', 'none')");
        $this->pdo->exec("INSERT INTO mp_mp_meals VALUES (6, 'Pasta Primavera', 'dinner', 'vegetarian')");

        // Meal ingredients
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (1, 1, 'oats', 1.00, 'cup')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (2, 1, 'almond milk', 1.50, 'cup')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (3, 1, 'honey', 1.00, 'tbsp')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (4, 2, 'eggs', 2.00, 'each')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (5, 2, 'english muffin', 1.00, 'each')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (6, 2, 'hollandaise', 2.00, 'tbsp')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (7, 3, 'romaine', 2.00, 'cup')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (8, 3, 'croutons', 0.50, 'cup')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (9, 3, 'parmesan', 1.00, 'tbsp')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (10, 4, 'tortilla', 1.00, 'each')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (11, 4, 'hummus', 2.00, 'tbsp')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (12, 4, 'mixed greens', 1.00, 'cup')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (13, 5, 'salmon', 6.00, 'oz')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (14, 5, 'lemon', 1.00, 'each')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (15, 5, 'asparagus', 4.00, 'spear')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (16, 6, 'pasta', 8.00, 'oz')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (17, 6, 'bell pepper', 1.00, 'each')");
        $this->pdo->exec("INSERT INTO mp_mp_meal_ingredients VALUES (18, 6, 'olive oil', 1.00, 'tbsp')");

        // Days reference
        $this->pdo->exec("INSERT INTO mp_mp_days VALUES (1, 'Mon')");
        $this->pdo->exec("INSERT INTO mp_mp_days VALUES (2, 'Tue')");
        $this->pdo->exec("INSERT INTO mp_mp_days VALUES (3, 'Wed')");
        $this->pdo->exec("INSERT INTO mp_mp_days VALUES (4, 'Thu')");
        $this->pdo->exec("INSERT INTO mp_mp_days VALUES (5, 'Fri')");
        $this->pdo->exec("INSERT INTO mp_mp_days VALUES (6, 'Sat')");
        $this->pdo->exec("INSERT INTO mp_mp_days VALUES (7, 'Sun')");

        // Weekly plan (partially filled)
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (1, 'Mon', 'breakfast', 1)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (2, 'Mon', 'lunch', 4)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (3, 'Mon', 'dinner', 5)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (4, 'Tue', 'breakfast', 2)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (5, 'Tue', 'lunch', 3)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (6, 'Tue', 'dinner', 6)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (7, 'Wed', 'breakfast', 1)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (8, 'Wed', 'dinner', 5)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (9, 'Thu', 'lunch', 4)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (10, 'Thu', 'dinner', 6)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (11, 'Fri', 'breakfast', 2)");
        $this->pdo->exec("INSERT INTO mp_mp_weekly_plan VALUES (12, 'Fri', 'lunch', 3)");
    }
    ...
    public function testWeeklyPlanOverview(): void
    {
        $rows = $this->ztdQuery(
            "SELECT wp.day_of_week, wp.meal_slot, m.name
             FROM mp_mp_weekly_plan wp
             JOIN mp_mp_meals m ON m.id = wp.meal_id
             JOIN mp_mp_days d ON d.day_name = wp.day_of_week
    ...
    public function testUnassignedSlots(): void
    {
        $rows = $this->ztdQuery(
            "SELECT d.day_name, slots.slot
             ...
             LEFT JOIN mp_mp_weekly_plan wp
    ...
    public function testShoppingListAggregation(): void
    {
        $rows = $this->ztdQuery(
            "SELECT mi.ingredient_name, SUM(mi.quantity) AS total_qty, mi.unit
             FROM mp_mp_weekly_plan wp
             JOIN mp_mp_meal_ingredients mi ON mi.meal_id = wp.meal_id
    ...
    public function testVegetarianMealsOnly(): void
    {
        $rows = $this->ztdQuery(
            "SELECT m.name, m.category, COUNT(mi.id) AS ingredient_count
             FROM mp_mp_meals m
             JOIN mp_mp_meal_ingredients mi ON mi.meal_id = m.id
    ...
    {
        $rows = $this->ztdQuery("SELECT COUNT(*) AS cnt FROM mp_mp_weekly_plan");
        $this->assertEquals(12, (int) $rows[0]['cnt']);

        $this->pdo->disableZtd();
        $rows = $this->pdo->query("SELECT COUNT(*) AS cnt FROM mp_mp_weekly_plan")->fetchAll(PDO::FETCH_ASSOC);
