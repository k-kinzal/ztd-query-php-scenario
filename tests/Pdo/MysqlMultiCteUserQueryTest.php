...
/**
 * Tests multiple user-defined CTEs in a single query through ZTD shadow store on MySQL.
 *
 ...
 * @spec SPEC-3.3
 */
class MysqlMultiCteUserQueryTest extends AbstractMysqlPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return [
            'CREATE TABLE mcu_orders (id INT PRIMARY KEY, customer_id INT, amount DECIMAL(10,2), region VARCHAR(20)) ENGINE=InnoDB',
            'CREATE TABLE mcu_customers (id INT PRIMARY KEY, name VARCHAR(50)) ENGINE=InnoDB',
        ];
    }
