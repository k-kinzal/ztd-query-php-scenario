 ...
 * @spec SPEC-3.3
 */
class MysqlMultiDistinctAggregateTest extends AbstractMysqlPdoTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("INSERT INTO mda_orders (id, customer_id, product, region, amount, status) VALUES
    ...
    {
        try {
            $this->pdo->exec("INSERT INTO mda_orders (id, customer_id, product, region, amount, status) VALUES (8, 40, 'Monitor', 'North', 800.00, 'completed')");
    ...
    {
        $this->disableZtd();
        $rows = $this->pdo->query("SELECT COUNT(*) AS cnt FROM mda_orders")
