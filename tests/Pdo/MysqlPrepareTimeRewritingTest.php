 ...
 */
class MysqlPrepareTimeRewritingTest extends TestCase
{
    private ZtdPdo $pdo;
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $raw->exec('DROP TABLE IF EXISTS mysql_ptr_items');
        $raw->exec('CREATE TABLE mysql_ptr_items (id INT PRIMARY KEY, name VARCHAR(50), price DECIMAL(10,2))');
        $raw->exec("INSERT INTO mysql_ptr_items VALUES (1, 'Physical A', 10.00)");
        $raw->exec("INSERT INTO mysql_ptr_items VALUES (2, 'Physical B', 20.00)");
    }
