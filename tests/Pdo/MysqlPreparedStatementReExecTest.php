 ...
 */
class MysqlPreparedStatementReExecTest extends TestCase
{
    private ZtdPdo $pdo;
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $raw->exec('DROP TABLE IF EXISTS re_exec_m');
        $raw->exec('CREATE TABLE re_exec_m (id INT PRIMARY KEY, name VARCHAR(50), score INT)');
    }
