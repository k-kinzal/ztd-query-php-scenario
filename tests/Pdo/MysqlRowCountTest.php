 ...
 * @spec SPEC-4.4
 */
class MysqlRowCountTest extends AbstractMysqlPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE rc_items (id INT PRIMARY KEY, name VARCHAR(50), category VARCHAR(10), active TINYINT)';
    }
