...
/**
 * Tests self-JOIN patterns through ZTD shadow store on MySQL.
 *
 ...
 * @spec SPEC-3.3
 */
class MysqlSelfJoinTest extends AbstractMysqlPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return [
            'CREATE TABLE sj_employees (id INT PRIMARY KEY, name VARCHAR(50), manager_id INT, salary INT) ENGINE=InnoDB',
        ];
    }
