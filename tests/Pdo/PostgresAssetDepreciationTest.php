...
/**
 * Tests an asset depreciation tracking scenario through ZTD shadow store (PostgreSQL PDO).
 ...
 * @spec SPEC-10.2.163
 */
class PostgresAssetDepreciationTest extends AbstractPostgresPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return [
            'CREATE TABLE pg_dep_assets (
    ...
    {
        return ['pg_dep_entries', 'pg_dep_assets'];
    }
    ...
    protected function setUp(): void
    {
        ...
        // 5 assets
        $this->pdo->exec("INSERT INTO pg_dep_assets VALUES (1, 'Office Laptop', 'equipment', '1500.00', '2024-01-15', 3, '150.00', 'active')");
        $this->pdo->exec("INSERT INTO pg_dep_assets VALUES (2, 'Delivery Van', 'vehicle', '35000.00', '2023-06-01', 7, '5000.00', 'active')");
        $this->pdo->exec("INSERT INTO pg_dep_assets VALUES (3, 'Server Rack', 'equipment', '12000.00', '2022-03-10', 5, '1000.00', 'active')");
        $this->pdo->exec("INSERT INTO pg_dep_assets VALUES (4, 'Office Desk', 'furniture', '800.00', '2023-01-20', 10, '80.00', 'active')");
        $this->pdo->exec("INSERT INTO pg_dep_assets VALUES (5, 'Old Printer', 'equipment', '500.00', '2020-01-01', 4, '50.00', 'disposed')");

        // 16 depreciation entries
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (1, 1, '2024', '450.00', '450.00', '1050.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (2, 1, '2025', '450.00', '900.00', '600.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (3, 2, '2023', '4285.71', '4285.71', '30714.29')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (4, 2, '2024', '4285.71', '8571.42', '26428.58')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (5, 2, '2025', '4285.71', '12857.13', '22142.87')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (6, 3, '2022', '2200.00', '2200.00', '9800.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (7, 3, '2023', '2200.00', '4400.00', '7600.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (8, 3, '2024', '2200.00', '6600.00', '5400.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (9, 3, '2025', '2200.00', '8800.00', '3200.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (10, 4, '2023', '72.00', '72.00', '728.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (11, 4, '2024', '72.00', '144.00', '656.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (12, 4, '2025', '72.00', '216.00', '584.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (13, 5, '2020', '112.50', '112.50', '387.50')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (14, 5, '2021', '112.50', '225.00', '275.00')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (15, 5, '2022', '112.50', '337.50', '162.50')");
        $this->pdo->exec("INSERT INTO pg_dep_entries VALUES (16, 5, '2023', '112.50', '450.00', '50.00')");
    }
    ...
    public function testCurrentBookValue(): void
    {
        $rows = $this->ztdQuery(
            "SELECT a.name, a.purchase_cost, d.book_value, d.period
             FROM pg_dep_assets a
             JOIN pg_dep_entries d ON d.asset_id = a.id
             WHERE d.period = (SELECT MAX(d2.period) FROM pg_dep_entries d2 WHERE d2.asset_id = a.id)
             ORDER BY a.id"
        );
    ...
    public function testPhysicalIsolation(): void
    {
        ...
        $this->pdo->exec("INSERT INTO pg_dep_assets VALUES (6, 'New Monitor', 'equipment', '600.00', '2026-01-01', 5, '60.00', 'active')");

        // Visible through ZTD
        $rows = $this->ztdQuery("SELECT COUNT(*) AS cnt FROM pg_dep_assets");
        $this->assertEquals(6, (int) $rows[0]['cnt']);

        // Physical table untouched
        $this->pdo->disableZtd();
        $rows = $this->pdo->query("SELECT COUNT(*) AS cnt FROM pg_dep_assets")->fetchAll(PDO::FETCH_ASSOC);
