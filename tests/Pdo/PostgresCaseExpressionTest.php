 ...
 */
class PostgresCaseExpressionTest extends AbstractPostgresPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE pg_case_products (
            id INT PRIMARY KEY,
            name TEXT NOT NULL,
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("INSERT INTO pg_case_products VALUES (1, 'USB Cable', 5.99, 'Accessories', 200)");
        $this->pdo->exec("INSERT INTO pg_case_products VALUES (2, 'Keyboard', 49.99, 'Electronics', 30)");
        $this->pdo->exec("INSERT INTO pg_case_products VALUES (3, 'Monitor', 299.99, 'Electronics', 8)");
        $this->pdo->exec("INSERT INTO pg_case_products VALUES (4, 'Notebook', 3.50, 'Office', 500)");
        $this->pdo->exec("INSERT INTO pg_case_products VALUES (5, 'Desk Lamp', 24.99, 'Office', 0)");
        $this->pdo->exec("INSERT INTO pg_case_products VALUES (6, 'Webcam', 79.99, 'Electronics', NULL)");
    }
    ...
    public function testCaseInUpdateSet(): void
    {
        ...
        $this->assertCount(6, $rows);
        // Discounted (stock > 10): PostgreSQL NUMERIC preserves precision
    ...
    {
        $this->pdo->disableZtd();
        $rows = $this->pdo->query("SELECT COUNT(*) AS cnt FROM pg_case_products")->fetchAll(PDO::FETCH_ASSOC);
