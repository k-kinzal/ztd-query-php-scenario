 ...
 */
class PostgresOptimisticLockingTest extends AbstractPostgresPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE ol_products (id INT PRIMARY KEY, name VARCHAR(255), price DECIMAL(10,2), version INT NOT NULL DEFAULT 1)';
    }
