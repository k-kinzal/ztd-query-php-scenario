 ...
 * @spec SPEC-2.2
 */
class PostgresPhysicalShadowOverlayTest extends AbstractPostgresPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE pg_pso_products (id INT PRIMARY KEY, name VARCHAR(50), price NUMERIC(10,2), category VARCHAR(30))';
    }

    protected function getTableNames(): array
    {
        return ['pg_pso_products'];
    }
