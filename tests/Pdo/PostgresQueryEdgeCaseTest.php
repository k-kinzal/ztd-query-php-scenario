 ...
 * @spec pending
 */
class PostgresQueryEdgeCaseTest extends AbstractPostgresPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE pg_edge_test (id INT PRIMARY KEY, name VARCHAR(255), score INT, category VARCHAR(255))';
    }
