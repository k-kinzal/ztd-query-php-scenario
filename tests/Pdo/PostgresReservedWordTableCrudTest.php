...
/**
 * Tests full CRUD on tables whose names are SQL reserved words on PostgreSQL-PDO.
 ...
 * @spec SPEC-4.3
 */
class PostgresReservedWordTableCrudTest extends AbstractPostgresPdoTestCase
{
