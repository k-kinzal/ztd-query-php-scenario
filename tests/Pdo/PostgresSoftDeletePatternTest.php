 ...
 */
class PostgresSoftDeletePatternTest extends AbstractPostgresPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE sd_tasks (id INT PRIMARY KEY, title VARCHAR(255), status VARCHAR(20), deleted_at TIMESTAMP NULL DEFAULT NULL)';
    }
