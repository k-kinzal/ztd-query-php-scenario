 ...
 * @spec SPEC-10.2.23
 */
class PostgresWindowFunctionEdgeCasesTest extends AbstractPostgresPdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE pg_wfe_metrics (
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("INSERT INTO pg_wfe_metrics (id, department, employee, salary, hire_date) VALUES (1, 'Eng', 'Alice', 90000, '2020-01-15')");
        $this->pdo->exec("INSERT INTO pg_wfe_metrics (id, department, employee, salary, hire_date) VALUES (2, 'Eng', 'Bob', 85000, '2021-03-10')");
        $this->pdo->exec("INSERT INTO pg_wfe_metrics (id, department, employee, salary, hire_date) VALUES (3, 'Eng', 'Charlie', 95000, '2019-06-01')");
        $this->pdo->exec("INSERT INTO pg_wfe_metrics (id, department, employee, salary, hire_date) VALUES (4, 'Sales', 'Diana', 70000, '2022-01-05')");
        $this->pdo->exec("INSERT INTO pg_wfe_metrics (id, department, employee, salary, hire_date) VALUES (5, 'Sales', 'Eve', 75000, '2021-08-20')");
        $this->pdo->exec("INSERT INTO pg_wfe_metrics (id, department, employee, salary, hire_date) VALUES (6, 'Sales', 'Frank', NULL, '2023-01-10')");
    }
    ...
    {
        // Give Eve a raise
        $this->pdo->exec("UPDATE pg_wfe_metrics SET salary = 80000 WHERE employee = 'Eve'");
    ...
    {
        // Insert a tie
        $this->pdo->exec("INSERT INTO pg_wfe_metrics (id, department, employee, salary, hire_date) VALUES (7, 'Eng', 'Grace', 90000, '2023-05-01')");
