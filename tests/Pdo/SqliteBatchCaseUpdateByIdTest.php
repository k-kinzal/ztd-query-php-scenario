 ...
 * @spec SPEC-4.2
 */
class SqliteBatchCaseUpdateByIdTest extends AbstractSqlitePdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return 'CREATE TABLE sl_bcu_users (
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("INSERT INTO sl_bcu_users VALUES (1, 'Alice', 'user', 10)");
        $this->pdo->exec("INSERT INTO sl_bcu_users VALUES (2, 'Bob', 'user', 20)");
        $this->pdo->exec("INSERT INTO sl_bcu_users VALUES (3, 'Carol', 'user', 30)");
        $this->pdo->exec("INSERT INTO sl_bcu_users VALUES (4, 'Dave', 'user', 40)");
    }
    ...
    public function testBatchUpdateSingleColumn(): void
    {
        try {
            ...
            $rows = $this->ztdQuery("SELECT id, name, role FROM sl_bcu_users ORDER BY id");
    ...
    public function testBatchUpdateMultipleColumns(): void
    {
        try {
            ...
            $rows = $this->ztdQuery("SELECT id, role, score FROM sl_bcu_users ORDER BY id");
            $this->assertCount(4, $rows);
    ...
    public function testBatchUpdatePreparedWithParams(): void
    {
        try {
            ...
            $rows = $this->ztdQuery("SELECT id, role FROM sl_bcu_users ORDER BY id");
    ...
    public function testBatchUpdateWithoutWhere(): void
    {
        try {
            ...
            $rows = $this->ztdQuery("SELECT id, score FROM sl_bcu_users ORDER BY id");
            $this->assertCount(4, $rows);
