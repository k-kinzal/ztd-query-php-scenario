 ...
 * GROUP BY with HAVING for dietary filters, and prepared statement for day lookup (SQLite PDO).
 * @spec SPEC-10.2.146
 */
class SqliteMealPlanningTest extends AbstractSqlitePdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return [
            'CREATE TABLE sl_mp_meals (
                id INTEGER PRIMARY KEY,
                name TEXT,
                category TEXT,
                dietary_tag TEXT
            )',
            'CREATE TABLE sl_mp_meal_ingredients (
                id INTEGER PRIMARY KEY,
                meal_id INTEGER,
            ...
            'CREATE TABLE sl_mp_weekly_plan (
                id INTEGER PRIMARY KEY,
                day_of_week TEXT,
                meal_slot TEXT,
                meal_id INTEGER
            )',
            'CREATE TABLE sl_mp_days (
                id INTEGER PRIMARY KEY,
                day_name TEXT
            )',
        ];
    ...
    {
        return ['sl_mp_days', 'sl_mp_meal_ingredients', 'sl_mp_meals', 'sl_mp_weekly_plan'];
    }
    ...
    protected function setUp(): void
    {
        ...
        // Meals
        $this->pdo->exec("INSERT INTO sl_mp_meals VALUES (1, 'Oatmeal', 'breakfast', 'vegan')");
        $this->pdo->exec("INSERT INTO sl_mp_meals VALUES (2, 'Eggs Benedict', 'breakfast', 'none')");
        $this->pdo->exec("INSERT INTO sl_mp_meals VALUES (3, 'Caesar Salad', 'lunch', 'none')");
        $this->pdo->exec("INSERT INTO sl_mp_meals VALUES (4, 'Veggie Wrap', 'lunch', 'vegetarian')");
        $this->pdo->exec("INSERT INTO sl_mp_meals VALUES (5, 'Grilled Salmon', 'dinner', 'none')");
        $this->pdo->exec("INSERT INTO sl_mp_meals VALUES (6, 'Pasta Primavera', 'dinner', 'vegetarian')");

        // Meal ingredients
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (1, 1, 'oats', 1.0, 'cup')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (2, 1, 'almond milk', 1.5, 'cup')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (3, 1, 'honey', 1.0, 'tbsp')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (4, 2, 'eggs', 2.0, 'each')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (5, 2, 'english muffin', 1.0, 'each')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (6, 2, 'hollandaise', 2.0, 'tbsp')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (7, 3, 'romaine', 2.0, 'cup')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (8, 3, 'croutons', 0.5, 'cup')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (9, 3, 'parmesan', 1.0, 'tbsp')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (10, 4, 'tortilla', 1.0, 'each')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (11, 4, 'hummus', 2.0, 'tbsp')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (12, 4, 'mixed greens', 1.0, 'cup')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (13, 5, 'salmon', 6.0, 'oz')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (14, 5, 'lemon', 1.0, 'each')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (15, 5, 'asparagus', 4.0, 'spear')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (16, 6, 'pasta', 8.0, 'oz')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (17, 6, 'bell pepper', 1.0, 'each')");
        $this->pdo->exec("INSERT INTO sl_mp_meal_ingredients VALUES (18, 6, 'olive oil', 1.0, 'tbsp')");

        // Days reference
        $this->pdo->exec("INSERT INTO sl_mp_days VALUES (1, 'Mon')");
        $this->pdo->exec("INSERT INTO sl_mp_days VALUES (2, 'Tue')");
        $this->pdo->exec("INSERT INTO sl_mp_days VALUES (3, 'Wed')");
        $this->pdo->exec("INSERT INTO sl_mp_days VALUES (4, 'Thu')");
        $this->pdo->exec("INSERT INTO sl_mp_days VALUES (5, 'Fri')");
        $this->pdo->exec("INSERT INTO sl_mp_days VALUES (6, 'Sat')");
        $this->pdo->exec("INSERT INTO sl_mp_days VALUES (7, 'Sun')");

        // Weekly plan (partially filled)
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (1, 'Mon', 'breakfast', 1)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (2, 'Mon', 'lunch', 4)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (3, 'Mon', 'dinner', 5)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (4, 'Tue', 'breakfast', 2)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (5, 'Tue', 'lunch', 3)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (6, 'Tue', 'dinner', 6)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (7, 'Wed', 'breakfast', 1)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (8, 'Wed', 'dinner', 5)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (9, 'Thu', 'lunch', 4)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (10, 'Thu', 'dinner', 6)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (11, 'Fri', 'breakfast', 2)");
        $this->pdo->exec("INSERT INTO sl_mp_weekly_plan VALUES (12, 'Fri', 'lunch', 3)");
    }
    ...
    public function testWeeklyPlanOverview(): void
    {
        $rows = $this->ztdQuery(
            "SELECT wp.day_of_week, wp.meal_slot, m.name
             FROM sl_mp_weekly_plan wp
             JOIN sl_mp_meals m ON m.id = wp.meal_id
             JOIN sl_mp_days d ON d.day_name = wp.day_of_week
             ORDER BY d.id,
                 CASE wp.meal_slot
    ...
    public function testUnassignedSlots(): void
    {
        $rows = $this->ztdQuery(
            "SELECT d.day_name, slots.slot
             ...
             LEFT JOIN sl_mp_weekly_plan wp
    ...
    public function testShoppingListAggregation(): void
    {
        $rows = $this->ztdQuery(
            "SELECT mi.ingredient_name, SUM(mi.quantity) AS total_qty, mi.unit
             FROM sl_mp_weekly_plan wp
             JOIN sl_mp_meal_ingredients mi ON mi.meal_id = wp.meal_id
    ...
    public function testVegetarianMealsOnly(): void
    {
        $rows = $this->ztdQuery(
            "SELECT m.name, m.category, COUNT(mi.id) AS ingredient_count
             FROM sl_mp_meals m
             JOIN sl_mp_meal_ingredients mi ON mi.meal_id = m.id
    ...
    {
        $rows = $this->ztdQuery("SELECT COUNT(*) AS cnt FROM sl_mp_weekly_plan");
        $this->assertEquals(12, (int) $rows[0]['cnt']);

        $this->pdo->disableZtd();
        $rows = $this->pdo->query("SELECT COUNT(*) AS cnt FROM sl_mp_weekly_plan")->fetchAll(PDO::FETCH_ASSOC);
