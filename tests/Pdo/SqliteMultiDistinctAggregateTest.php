 ...
 * @spec SPEC-3.3
 */
class SqliteMultiDistinctAggregateTest extends AbstractSqlitePdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return "CREATE TABLE sl_mda_orders (
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("INSERT INTO sl_mda_orders (id, customer_id, product, region, amount, status) VALUES
    ...
    {
        try {
            $this->pdo->exec("INSERT INTO sl_mda_orders (id, customer_id, product, region, amount, status) VALUES (8, 40, 'Monitor', 'North', 800.00, 'completed')");
    ...
    {
        $this->pdo->disableZtd();
        $rows = $this->pdo->query("SELECT COUNT(*) AS cnt FROM sl_mda_orders")
