 ...
 * @spec SPEC-3.7
 */
class SqliteNullInAggregatesTest extends AbstractSqlitePdoTestCase
{
    protected function getTableDDL(): string|array
    {
        return [
            'CREATE TABLE scores (id INTEGER PRIMARY KEY, student TEXT, subject TEXT, score INTEGER)',
            'CREATE TABLE profiles (id INTEGER PRIMARY KEY, name TEXT, city TEXT)',
        ];
    }
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("INSERT INTO scores VALUES (1, 'Alice', 'Math', 90)");
        $this->pdo->exec("INSERT INTO scores VALUES (2, 'Alice', 'English', NULL)");
        $this->pdo->exec("INSERT INTO scores VALUES (3, 'Bob', 'Math', 80)");
        $this->pdo->exec("INSERT INTO scores VALUES (4, 'Bob', 'English', NULL)");
        $this->pdo->exec("INSERT INTO scores VALUES (5, 'Charlie', 'Math', NULL)");
        $this->pdo->exec("INSERT INTO scores VALUES (6, 'Charlie', 'English', NULL)");

        $this->pdo->exec("INSERT INTO profiles VALUES (1, 'Alice', 'NYC')");
        $this->pdo->exec("INSERT INTO profiles VALUES (2, 'Bob', NULL)");
        $this->pdo->exec("INSERT INTO profiles VALUES (3, 'Dave', 'LA')");
    }
    ...
    {
        $rows = $this->ztdQuery("
            SELECT student, GROUP_CONCAT(score, ',') AS scores_csv
            FROM scores
            GROUP BY student
            ORDER BY student
        ");
