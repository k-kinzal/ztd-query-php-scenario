 ...
 * @spec SPEC-10.2.23
 */
class SqliteWindowFunctionEdgeCasesTest extends AbstractSqlitePdoTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("INSERT INTO metrics VALUES (1, 'Eng', 'Alice', 90000, '2020-01-15')");
        $this->pdo->exec("INSERT INTO metrics VALUES (2, 'Eng', 'Bob', 85000, '2021-03-10')");
        $this->pdo->exec("INSERT INTO metrics VALUES (3, 'Eng', 'Charlie', 95000, '2019-06-01')");
        $this->pdo->exec("INSERT INTO metrics VALUES (4, 'Sales', 'Diana', 70000, '2022-01-05')");
        $this->pdo->exec("INSERT INTO metrics VALUES (5, 'Sales', 'Eve', 75000, '2021-08-20')");
        $this->pdo->exec("INSERT INTO metrics VALUES (6, 'Sales', 'Frank', NULL, '2023-01-10')");
    }
    ...
    {
        // Give Eve a raise
        $this->pdo->exec("UPDATE metrics SET salary = 80000 WHERE employee = 'Eve'");
    ...
    {
        // Insert a tie
        $this->pdo->exec("INSERT INTO metrics VALUES (7, 'Eng', 'Grace', 90000, '2023-05-01')");
